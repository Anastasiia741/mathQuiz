    ...
    static var quizData: [QuizModel] {
        [
            ...
            QuizModel(theme: "Calculus", question: "What is the derivative of x^2?", 
                      answer: "B",
                      description: "Mathematical analysis is the study of continuous change and includes topics such as limits, derivatives, and integrals. These concepts are used to analyze functions and model dynamic processes.",
